; ========================================
; Project    C128 Kernal Menu
; Target     Commodore 128
; Comments   Custom menu kernal for use with the THT multi-ROM as a menu driven kernal switch in a C128
; Comments   modified by xboxpro1
; Author     RetroNinja
; ========================================
; Version history
...
; 2.0   Renamed switcher, changed ascii command, disabled sprite

CHARSET   2
NOLOADADDR
GenerateTo c128minikernal.bin
...
; ascii CBMROM128# command for kernal switcher on data bus
cmdasc ; CBMROM128#
  byte $43, $42, $4d, $52, $4f, $4d, $31, $32, $38, $23
cmdascend
; ascii CBMROM128DCR# command for C128DCR combo switch
cmdascdcr
        byte $43, $42, $4d, $52, $4f, $4d, $31, $32, $38, $44, $43, $52, $23
cmdascdcrend

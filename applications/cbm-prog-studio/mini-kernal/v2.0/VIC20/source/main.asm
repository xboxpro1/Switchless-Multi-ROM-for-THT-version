...
; ========================================
; Version history
; 2.0   Renamed switcher, changed ascii command

CHARSET   2
NOLOADADDR
GenerateTo vic20minikernal.bin
...
; ascii CBMROM20# command for kernal switcher on data bus
cmdasc  byte $43, $42, $4d, $52, $4f, $4d, $32, $30, $23
cmdascend
